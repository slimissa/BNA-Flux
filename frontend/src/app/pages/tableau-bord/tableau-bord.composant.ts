    ...
    <div style="padding:40px;background:#0d1b2a;min-height:100vh;color:#e0e6ed;font-family:'Inter',sans-serif">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:30px">
        <div style="background:#162840;border:1px solid rgba(74,158,255,0.15);border-radius:12px;padding:24px">
          <h3 style="color:#e0e6ed;margin-bottom:16px">📊 Répartition des transactions</h3>
          <canvas id="chart-donut" style="max-height:250px"></canvas>
        </div>
        <div style="background:#162840;border:1px solid rgba(74,158,255,0.15);border-radius:12px;padding:24px">
          <h3 style="color:#e0e6ed;margin-bottom:16px">📈 Alertes par sévérité</h3>
      ...
      if (barCtx && data?.statistiques) {
        new Chart(barCtx, {
          ...
          options: {
            ...
            scales: {
              y: { beginAtZero: true, ticks: { color: '#5a6d80' }, grid: { color: 'rgba(74,158,255,0.05)' } },
              x: { ticks: { color: '#5a6d80' }, grid: { display: false } }
            }
          }
        });
      }

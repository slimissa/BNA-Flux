...
function createPlatformFactory(parentPlatformFactory, name, providers = []) {
  ...
  return (extraProviders = []) => {
    ...
    if (!platform || platform.injector.get(ALLOW_MULTIPLE_PLATFORMS, false)) {
      ...
      platform = (_a2 = parentPlatformFactory == null ? void 0 : parentPlatformFactory(platformProviders)) != null ? _a2 : createPlatform(createPlatformInjector(platformProviders, desc));
    }
...
function internalCreateApplication(config) {
  ...
  try {
    const platformInjector = (_a2 = platformRef == null ? void 0 : platformRef.injector) != null ? _a2 : createOrReusePlatformInjector(platformProviders);
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-EVRMZ3JJ.js.map
